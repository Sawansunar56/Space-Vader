...
BULLET_SOUND = pygame.mixer.Sound(os.path.join('Assets', 'mixkit-game-gun-shot-1662.mp3'))
DESTROY_SOUND = pygame.mixer.Sound(os.path.join('Assets', 'mixkit-short-laser-gun-shot-1670.mp3'))
...
SPACESHIP_WIDTH, SPACESHIP_HEIGHT = 40, 35
...
def red_handle_movement(key_pressed, red):
  if key_pressed[pygame.K_LEFT] and red.x - VEL > BORDER.x + BORDER.width :
    red.x -= VEL
  elif key_pressed[pygame.K_RIGHT] and red.x + VEL < WIDTH - red.width:
    red.x += VEL
  elif key_pressed[pygame.K_DOWN] and red.y + VEL < HEIGHT - 38:
    red.y += VEL
...
def yellow_handle_movement(key_pressed, yellow):
  if key_pressed[pygame.K_a] and yellow.x - VEL > 0 :
    yellow.x -= VEL
  elif key_pressed[pygame.K_d] and yellow.x + VEL + yellow.width < BORDER.x:
    yellow.x += VEL
  elif key_pressed[pygame.K_s] and yellow.y + VEL < HEIGHT - 38:
    yellow.y += VEL
